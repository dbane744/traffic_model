...
public class IO {
  ...
  public static double[][] readData() {
    ...
    // The file String array is instantiated using the previously counted number
    // of lines.
    ...
    for (int i = 0; i < lines; i++) {
      // Delimits individual strings using the "," character on a line by line
      // basis.
  ...
  public static void writeData(double[][] dataIn) {
    ...
    FileDialog fd = new FileDialog(new Frame(), "Save the file", FileDialog.SAVE);
